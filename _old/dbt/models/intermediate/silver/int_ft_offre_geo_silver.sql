with offres_normalized as (
    select
        ...
        nullif(trim(o."salaire__libelle"), '') as remuneration_libelle,
        nullif(trim(o."salaire__commentaire"), '') as remuneration_commentaire,
...
select
    ...
    o.remuneration_libelle,
    o.remuneration_commentaire,
    o.salaire_libelle,
