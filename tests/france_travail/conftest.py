...
MY_SRC = os.path.join(PROJECT_ROOT, "02_extract", "france_travail")
...
def mock_env_local(monkeypatch):
    ...
    monkeypatch.setenv("FT_CLIENT_ID", "test-client-id")
    monkeypatch.setenv("FT_CLIENT_KEY", "test-client-key")
